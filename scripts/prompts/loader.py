...
1. 时长 60-120 秒（按每分钟 150 词估算，约 150-300 词）
   - 故事类内容（需要完整叙事弧线）可放宽到 90-150 秒
...
3. 结尾必须是自然收束
   - 必须是完整句子，最后一个字符是 . ! ? 或引号
   - 禁止结尾：以 "and" "but" "or" "because" "which" 这类词结尾
   - 禁止结尾：广告/节目套话（"coming up after the break" "sponsored by" "subscribe" "stay tuned" "we'll be right back"）
  ...
  "segments": [
    {
      ...
      "end_time": 248.2,
      "duration_sec": 67.7,
      "reason": "简短说明为什么这段符合 tier 标准（20 字以内）",
